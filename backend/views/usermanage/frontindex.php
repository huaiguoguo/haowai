<?php $this->renderpartial('/include/header');?><!--加载头部-->
    <div class="nav">
        <ul class="cc">
            <li class="current"><a href="<?php echo HostName_Backed;?>/Usermanage/frontindex">用户管理</a></li>
        </ul>
    </div>
<!--     <div class="h_a">提示信息</div>
    ...
    <div class="mb10"><a class="btn J_dialog" href="<?php echo HostName_Backed;?>/Usermanage/addfrontuser" title="添加用户" role="button"><span class="add"></span>添加用户</a></div>
        ...
        <table width="100%">
            ...
            <?php foreach($userlist as $key=>$value):?>
                <tr>
                    ...
                    <td><a href="<?php echo HostName_Backed;?>/Usermanage/editfrontuser?id=<?php echo $value->id;?>" class="mr10" title="编辑">[编辑]</a>
