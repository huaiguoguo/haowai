...
<div class="nav">
    <ul class="cc">
        <li class="current"><a href="<?php echo HostName_Backed;?>/Post/index">事务办理文章</a></li>
    </ul>
</div>
<!--==============================咨讯列表================================-->
    <div class="mb10">
        <a href="<?php echo HostName_Backed;?>/Post/addpost" class="btn" title="添加文章"><span class="add"></span>添加咨讯</a>
    </div>
    <form class="J_ajaxForm" action="<?php echo HostName_Backed;?>/Post/postdel" method="post">
        ...
        <table width="100%">
            ...
            <?php foreach($postlist as $key=>$value):?>
                <tr>
                    ...
                    <td>
                    <a href="<?php echo HostName_Backed;?>/Post/Editpost?pid=<?php echo $value['id'];?>" title="编辑文章" class="mr10">[编辑]</a>
                    <a href="<?php echo HostName_Backed;?>/Post/postdel?pid=<?php echo $value['id'];?>" class="mr10 J_ajax_del" data-pdata="{'aid': '<?php echo $value['id'];?>'}">[删除]</a></td>
                </tr>
            <?php endforeach;?>
            </tbody>
        </table>
        ...
        Wind.dialog({
            ...
            onOk    : function() {
                $('form.J_ajaxForm').ajaxSubmit({
                    dataType : 'json',
                    url      : "<?php echo HostName_Backed;?>/Post/postdel",
