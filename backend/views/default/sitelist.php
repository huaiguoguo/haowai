                        ...
                        <div class="box-content">
                            <div class="row-fluid">
                                <div class="span8 control-group">
                                    <a href="<?=HostName_Backed;?>/default/addsite" class="btn"><i class="icon-plus"></i>添加游戏</a>
                                </div>
                            </div>
                                ...
                                <table id="listTable" class="table table-bordered table-hover dataTable">
                                    ...
                                    <?php foreach($sitelist as $key=>$value):?>
                                        <tr>
                                                ...
                                                <td>
                                                <a href="<?=HostName_Backed;?>/default/editsite?id=<?=$value['id'];?>" class="btn">编辑</a>
                                                <a href="javascript:G.ui.tips.confirm('确定要删除吗？', '<?=HostName_Backed;?>/default/DelSite/id/<?=$value['id'];?>');" class="btn">删除</a>
                                                </td>
                                        </tr>
                                    <?php endforeach;?>
                              </table>
