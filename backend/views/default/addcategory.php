...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            ...
            <form action="<?=HostName_Backed;?>/default/addcategory" method="post" class="form-horizontal form-validate">
